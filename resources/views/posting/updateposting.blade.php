...
@section('content')
    <div class="panel">
        <div class="panel-body">
            ...
            @endif
            <form action="{{ route('updatePosting', ['id' => $post['id']]) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                    <label class="sr-only" for="judulposting">Judul Posting</label>
                    <input type="text" class="form-control" name="judulposting" placeholder="Judul Posting" value="{{ $post['judulposting'] }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="date" name="tanggal" placeholder="Tanggal" value="{{ $post['tanggal'] }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <textarea class="form-control" name="deskripsi" placeholder="Deskripsi" value="{{ $post['deskripsi'] }}"></textarea>
                </div>
                <div class="form-group">
                    <button type="submit" class="blckbtn form-control">EDIT POSTING</button>
                </div>
            </form>
        </div>
    </div>
